...
import { z } from "zod"
import { BarSchema, updateBarSchema } from "./Bar"
import { MuseumSchema, updateMuseumSchema } from "./Museum"
import { ParkSchema, updateParkSchema } from "./Park"
import { RestaurantSchema, updateRestaurantSchema } from "./Restaurant"
...
export const filterQueryPlaces = z
	.object({
		q: z.string(),
		limit: z
			.string()
